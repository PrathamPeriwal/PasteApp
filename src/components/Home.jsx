      ...
      <div className="flex flex-col gap-y-5 items-start">
        ...
        <div className="w-full flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          ...
          <input
            ...
            className={`${pasteId ? "w-full sm:w-[80%]" : "w-full sm:w-[85%]"} text-black border border-input rounded-md p-2`}
          />
          
          <div className="flex gap-2 w-full sm:w-auto">
            <button
              className="flex-1 sm:flex-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700"
              onClick={createPaste}
            >
